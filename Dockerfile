...
RUN set -e; \
    ...
    curl -fL -sS --connect-timeout 15 --max-time 120 --retry 5 --retry-delay 5 -o ${name}_${version}_x5.0_${TARGETOS}_${TARGETARCH}.zip ${source}/releases/download/${version}/${name}_${version}_x5.0_${TARGETOS}_${TARGETARCH}.zip; \
